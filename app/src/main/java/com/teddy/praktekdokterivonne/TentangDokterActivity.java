...
public class  TentangDokterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tentang_dokter);

        //buka webnya
        webView = (WebView) findViewById(R.id.tentangdokter_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://dokter.yuk-kunjungi.com/dokter-ivonne/about/");
